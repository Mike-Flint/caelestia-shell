...
QtObject {
    ...
    readonly property list<QtObject> panes: [
        ...
        QtObject {
            readonly property string id: "touch"
            readonly property string label: "touch"
            readonly property string icon: "ads_click"
            readonly property string component: "touch/TouchPane.qml"
        }
    ]
